...
/**
 *
 * the new class will have two interfaces added: the WindowListener and the
 * ActionListener This is class for making display of the calculator
 *
...
public class CalculatorApplication extends JFrame implements WindowListener, ActionListener {
    ...
    /**
     * Main program area main program to display the frame with all of its
     * features This is the main method for this program
     *
    ...
    /**
     * add numbers to Box1 for showing input This method is for getting input
     *
    ...
    /**
     * Activate the frame when it is maximized This method is activate the frame
    ...
    /**
     * Minimize the frame This method is showing output when minimize the frame
     *
    ...
    /**
     * Maximize the frame This method is showing output when maximize the frame
     *
    ...
    /**
     * Deactivae the frame when it is iconized This method is showing output
     * when deactivate the frame when it is iconized
     *
    ...
    /**
     * all done , clean up and go home This method is showing output when window
     * is closing
     *
    ...
    /**
     * Close the frame display This method is moment when window is closing but
     * it does not show on output
     *
    ...
    /**
     * these are the actions taken within the window take action when the button
     * is selected
     *
    ...
    public class CalcBtn extends JButton implements ActionListener {
        ...
        /**
         * This method is action when button typed. Also doing calculate when
         * push "=" button.
         *
